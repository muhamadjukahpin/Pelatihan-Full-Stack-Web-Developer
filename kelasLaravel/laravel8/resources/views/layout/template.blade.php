...
<head>
    ...
    <meta name="keywords" content="{{$title}}, eCommerce, creative, html">
...
<body>
    ...
    <section class="footer-section">
        <div class="container">
            <div class="footer-logo text-center">
                <a href="/"><img src="{{asset('divisima')}}/img/logo-light.png" alt="Logo"></a>
            </div>
            <div class="row">
    ...
    <script src="{{asset('divisima')}}/js/popper.min.js"></script>
