...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col">
            <form action="<?php echo url('/Controller/ProductController.php?action=update'); ?>" method="POST">
                ...
                <div class="form-group row d-flex justify-content-end">
                    <div class="col-sm-10">
                        <a href="<?php echo url('product') ?>" class="btn btn-sm btn-secondary">Back</a>
